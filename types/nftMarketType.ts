...
export type ContractContext = EthersContractContextV5<
  NftMarketType,
  NftMarketTypeMethodNames,
  NftMarketTypeEventsContext,
  NftMarketTypeEvents
>;
...
export type NftMarketTypeEvents =
  | 'Approval'
  | 'ApprovalForAll'
  | 'BatchMetadataUpdate'
  | 'MetadataUpdate'
  ...
  | 'Transfer';
export interface NftMarketTypeEventsContext {
...
export type NftMarketTypeMethodNames =
  | 'new'
  | 'approve'
  | 'balanceOf'
  | 'buyNft'
...
export interface NftMarketType {
  /**
   * Payable: false
   * Constant: false
